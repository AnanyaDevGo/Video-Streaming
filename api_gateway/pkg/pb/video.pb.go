...
func file_pkg_pb_video_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_pb_video_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_pb_video_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_pb_video_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
